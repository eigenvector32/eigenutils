...
describe('Tests for DualEmitter', () => {
    ...
    test('Disposing a listener removes the event handler', () => {
        ...
        const emitter: DualEmitter<number> = new DualEmitter<number>(FireMode.Synchronous);
    ...
    test('Fire Microtask', async () => {
        ...
        const emitter: DualEmitter<number> = new DualEmitter<number>(FireMode.Microtask);
        emitter.event((newNumber: number) => {
            testNumber = newNumber;
        });
    ...
    test('Fire Debounce', async () => {
        ...
        const emitter: DualEmitter<number> = new DualEmitter<number>(FireMode.Debounce);
        emitter.event((newNumber: number) => {
            testNumber = newNumber;
            count++;
        });
    ...
    test('Fire Microtask | Debounce', async () => {
        ...
        const emitter: DualEmitter<number> = new DualEmitter<number>(FireMode.Microtask | FireMode.Debounce);
        emitter.event((newNumber: number) => {
            testNumber = newNumber;
            count++;
        });
