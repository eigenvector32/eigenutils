...
describe('Tests for WeakVoidEmitter', () => {
    ...
    test('Disposing a listener removes the event handler', () => {
        ...
        const emitter: WeakVoidEmitter = new WeakVoidEmitter(FireMode.Synchronous);
    ...
    test('Fire Microtask', async () => {
        ...
        const emitter: WeakVoidEmitter = new WeakVoidEmitter(FireMode.Microtask);
        emitter.event(() => {
            count++;
        });
    ...
    test('Fire Debounce', async () => {
        ...
        const emitter: WeakVoidEmitter = new WeakVoidEmitter(FireMode.Debounce);
        emitter.event(() => {
            count++;
        });
    ...
    test('Fire Microtask | Debounce', async () => {
        ...
        const emitter: WeakVoidEmitter = new WeakVoidEmitter(FireMode.Microtask | FireMode.Debounce);
        emitter.event(() => {
            count++;
        });
