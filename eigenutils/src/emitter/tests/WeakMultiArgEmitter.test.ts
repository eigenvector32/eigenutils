...
describe('Tests for WeakMultiArgEmitter', () => {
    test('Objects held only by the emitter are finalized', async () => {
        expect(gc).toBeDefined();

        let testHandler: (() => void) | null = () => { };

        const emitter: WeakMultiArgEmitter<[number, string]> = new WeakMultiArgEmitter<[number, string]>();
    ...
    test('Disposing a listener removes the event handler', () => {
        ...
        const emitter: WeakMultiArgEmitter<[number, string]> = new WeakMultiArgEmitter<[number, string]>(FireMode.Synchronous);
    ...
    test('Fire Microtask', async () => {
        ...
        const emitter: WeakMultiArgEmitter<[number, string]> = new WeakMultiArgEmitter<[number, string]>(FireMode.Microtask);
        emitter.event((newNumber: number, newString: string) => {
            testNumber = newNumber;
            testString = newString;
        });
    ...
    test('Fire Debounce', async () => {
        ...
        const emitter: WeakMultiArgEmitter<[number, string]> = new WeakMultiArgEmitter<[number, string]>(FireMode.Debounce);
        emitter.event((newNumber: number, newString: string) => {
            testNumber = newNumber;
            testString = newString;
            count++;
    ...
    test('Fire Microtask | Debounce', async () => {
        ...
        const emitter: WeakMultiArgEmitter<[number, string]> = new WeakMultiArgEmitter<[number, string]>(FireMode.Microtask | FireMode.Debounce);
        emitter.event((newNumber: number, newString: string) => {
            testNumber = newNumber;
            testString = newString;
            count++;
