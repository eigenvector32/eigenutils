...
describe('Tests for Emitter', () => {
    test('Adding the same listener twice is called once during fire', () => {
        ...
        const emitter: Emitter<number> = new Emitter<number>();
    ...
    test('Disposing a listener removes the event handler', () => {
        ...
        const emitter: Emitter<number> = new Emitter<number>(FireMode.Synchronous);
    ...
    test('Fire Microtask', async () => {
        ...
        const emitter: Emitter<number> = new Emitter<number>(FireMode.Microtask);
        emitter.event((newNumber: number) => {
            testNumber = newNumber;
        });
    ...
    test('Fire Debounce', async () => {
        ...
        const emitter: Emitter<number> = new Emitter<number>(FireMode.Debounce);
        emitter.event((newNumber: number) => {
            testNumber = newNumber;
            count++;
        });
    ...
    test('Fire Microtask | Debounce', async () => {
        ...
        const emitter: Emitter<number> = new Emitter<number>(FireMode.Microtask | FireMode.Debounce);
        emitter.event((newNumber: number) => {
            testNumber = newNumber;
            count++;
        });
